...
namespace TimeConverter.Domain.Test
{
    ...
    public class TimeConverterRepositoryTest
    {
        ...
        public void ConvertDate12HrTimeToSecondsTest()
        {
            ...
            // Act
            double resultSecs = _repositoryMockObject.ConvertDateTimeObjToSeconds(targetDateTime);
        ...
        public void ConvertSecondsToCurrentDateTimeTest()
        {
            ...
            // Act
            DateTime resultDateTime = _repositoryMockObject.ConvertSecondsToDateTimeObj(_refSeconds);
